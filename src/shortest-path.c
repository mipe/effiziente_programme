...
static inline int hash_super(PrimNum *start, int length)
{
  int i, r;
...
static inline struct super_state **lookup_super(PrimNum *start, int length)
{
...
static inline void prepare_super_table()
{
  int i;
  int nsupers = 0;
...
static inline void init_waypoints(struct waypoint ws[])
{
  int k;
