...
void papif_get_exe_info_ ( char *fullname, char *name, long long *text_start, long long *text_end, long long *data_start, long long *data_end, long long *bss_start, long long *bss_end, char *lib_preload_env, int *check, int fullname_len, int name_len, int lib_preload_env_len )
...
void papif_perror_ ( int *code, char *destination_str, int *check, int destination_len )
